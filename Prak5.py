...
@st.cache_resource
def load_models():
    yolo_model = YOLO("model/Nayma Alaydia_Laporan 4.pt")  # YOLOv8 Model
...
# ============================================================
    ...
    ### 🎓 Dashboard UTS Praktikum Pemrograman Big Data  
        ...
        secara visual. Melalui implementasi ini, konsep **Dat Gambar** diintegrasikan dengan pendekatan **Big Data** untuk memahami bagaimana data dapat diolah, 
